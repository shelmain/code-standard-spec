...
describe('Validate TS configs', () => {
  it('Validate code-standard-eslint-config/typescript', async () => {
  ...
  it('Validate code-standard-eslint-config/typescript/vue', async () => {
  ...
  it('Validate code-standard-eslint-config/essential/typescript', async () => {
  ...
  it('Validate code-standard-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate code-standard-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate code-standard-eslint-config/typescript/node', async () => {
