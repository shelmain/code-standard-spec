...
describe('Validate JS configs', () => {
  it('Validate code-standard-eslint-config', async () => {
  ...
  it('Validate code-standard-eslint-config/es5', async () => {
  ...
  it('Validate code-standard-eslint-config/vue', async () => {
  ...
  it('Validate code-standard-eslint-config/essential', async () => {
  ...
  it('Validate code-standard-eslint-config/essential/es5', async () => {
  ...
  it('Validate code-standard-eslint-config/essential/react', async () => {
  ...
  it('Validate code-standard-eslint-config/essential/vue', async () => {
  ...
  it('Validate code-standard-eslint-config/node', async () => {
